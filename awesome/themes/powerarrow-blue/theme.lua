   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("theme.bg_normal", "#44475a"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#44475a"),
            arrow("#44475a", "#282a36"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#282a36"),
            arrow("#282a36", "#44475a"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#44475a"),
            --arrow("#44475a", "#282a36"),
            --wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), "#282a36"),
            --arrow("#282a36", "#44475a"),
            --wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#44475a"),
            arrow("#44475a", "#282a36"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#282a36"),
            arrow("#282a36", "#44475a"),
            wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), "#44475a"),
            arrow("#44475a", "alpha"),
            --]]
            s.mylayoutbox,
